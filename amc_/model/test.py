...
from amc_.model.model_distilbert import DistilBertForSeq2Seq, DistilBertForConditionalGeneration
...
model = DistilBertForConditionalGeneration("monologg/distilkobert", config)
