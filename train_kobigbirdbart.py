...
############### 추가 부분 #######################33
from models.modeling_kobigbird_bart import (EncoderDecoderModel, BigBirdConfigWithDoctype, 
                                            BartConfigWithDoctype, BigBirdModelWithDoctype, BartDecoderWithDoctype)
##################################################
...
def main():
    ...
    print('** Dataset example', train_dataset[0]['title'], valid_dataset[0]['title'], sep = '\n')
