    ...
    def _pad(
        ...
        if needs_to_be_padded:
            ...
            if self.padding_side == "right":
                ...
                if 'doc_type_ids' in encoded_inputs :
                    encoded_inputs["doc_type_ids"] = encoded_inputs["doc_type_ids"] + [0] * difference
                ...
                if 'doc_type_ids' in encoded_inputs :
                    encoded_inputs["doc_type_ids"] = [0] * difference + encoded_inputs["doc_type_ids"]
