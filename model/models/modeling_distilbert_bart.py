...
# Copied from transformers.models.bert.modeling_bert.BertSelfAttention with Bert->DistilBert
...
# Copied from transformers.models.bert.modeling_bert.BertAttention with Bert->DistilBert
class DistilBertAttention(nn.Module):
    def __init__(self, config, position_embedding_type=None):
        super().__init__()
        self.self = DistilBertSelfAttention(config, position_embedding_type=position_embedding_type)
...
# Copied from transformers.models.bert.modeling_bert.BertLayer with Bert->DistilBert
class DistilBertLayer(nn.Module):
    def __init__(self, config):
        ...
        if self.add_cross_attention:
            ...
            self.crossattention = DistilBertAttention(config, position_embedding_type="absolute")
...
# Copied from transformers.models.bert.modeling_bert.BertEncoder with Bert->DistilBert
...
class DistilBertPreTrainedModel(PreTrainedModel):
    ...
    def _set_gradient_checkpointing(self, module, value=False):
        if isinstance(module, DistilBertEncoder):
...
class DistilBertModel(DistilBertPreTrainedModel):
    ...
    # Copied from transformers.models.bert.modeling_bert.BertModel.__init__ with Bert->DistilBert
...
class DistilBertSeq2SeqModel(DistilBertPreTrainedModel):
...
class DistilBertForConditionalGeneration(DistilBertPreTrainedModel):
